...
## Result
- Solution URL: [Frontendmentor](https://www.frontendmentor.io/solutions/job-listings-with-filtering-using-js-vanilla-sass-and-bem-895XPtukj)
- Live Site URL: [Job listings with filtering](https://job-listing-filtering.netlify.app/)
